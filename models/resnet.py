...
def resnet20_v2_cifar(**kwargs):
    model = ResNet_Cifar(BasicBlockv2, [3, 3, 3], **kwargs)
    return model
...
def resnet20_v2_cifar_modified(**kwargs):
    model = ResNet_Cifar_Modified(BasicBlockv2, [2, 2, 2, 2], **kwargs)
    return model
...
def resnet56_cifar_modified(**kwargs):
    model = ResNet_Cifar_Modified(BasicBlock, [9, 9, 9], **kwargs)
    return model
